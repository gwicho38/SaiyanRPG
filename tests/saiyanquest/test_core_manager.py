...
from saiyanquest.constants.paths import LIBDIR
from saiyanquest.core.core_manager import (
    ConditionManager,
    CoreManager,
    EffectManager,
)
from saiyanquest.db import CommonCondition, CommonEffect
...
class TestCoreManager(unittest.TestCase):
    def setUp(self):
        ...
        self.path = self.temp_dir / "saiyanquest"
    ...
    @patch("saiyanquest.plugin.load_plugins")
    ...
    def test_load_plugin_failure(self, mock_import_module):
        ...
        with self.assertLogs("saiyanquest", level="ERROR"):
