...
from saiyanquest.monster_dir.sprite import MonsterSpriteHandler
...
class TestMonsterSpriteHandler(unittest.TestCase):
    ...
    def test_resolve_path_valid(self):
        with patch(
            "saiyanquest.tools.transform_resource_filename",
    ...
    @patch("saiyanquest.graphics.load_sprite")
    ...
    @patch("saiyanquest.graphics.load_animated_sprite")
    @patch(
        "saiyanquest.tools.transform_resource_filename", side_effect=lambda p: p
    )
    ...
    @patch("saiyanquest.graphics.load_and_scale")
