...
from saiyanquest import graphics
...
from saiyanquest.tools import scale as saiyanquest_scale

if TYPE_CHECKING:
    from saiyanquest.db import BattleIconsModel
...
class CaptureDeviceSprite(Sprite):
    ...
    def animate_capture(self, animate: Callable[..., object]) -> None:
        ...
        animate(sprite.rect, bottom=self.tray.rect.top + saiyanquest_scale(3))
