...
"""Main entry point for SaiyanQuest game."""

from argparse import ArgumentParser, Namespace
import sys
from saiyanquest import main as main_module, prepare
...
def main() -> None:
    """Main entry point for the SaiyanQuest game."""
    ...
    try:
        ...
        if args.headless:
            main_module.headless(config=config)
        else:
            main_module.main(config=config, load_slot=args.slot)
