...
from saiyanquest import config
...
def _setup_user_environment() -> config.SaiyanQuestConfig:
    ...
    loaded_config = config.SaiyanQuestConfig(paths.USER_CONFIG_PATH)
...
def pygame_init() -> None:
    ...
    from saiyanquest import platform_interface as platform
    ...
    from saiyanquest.platform_interface import is_android
