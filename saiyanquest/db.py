...
from saiyanquest.formula import config_monster
...
class ModData:
    ...
    def preload(self, directory: str = "all") -> None:
        ...
        Parameters:
            directory: The directory under mods/saiyanquest/db/ to load. Defaults
                to "all".
        """
        if directory == "all":
            if self.config.mod_tables:
    ...
    def get_mod_attribute(
        ...
        Parameters:
            mod_name: The directory name of the mod (e.g., "saiyanquest").
