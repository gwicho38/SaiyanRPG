...
if TYPE_CHECKING:
    ...
    from saiyanquest.event.eventaction import ActionManager, EventAction
...
class EventEngine:
    ...
    def __init__(
        ...
        self.name = "Event"
        self.current_map: Optional[SaiyanQuestMap] = None
        self.timer = 0.0
        self.wait = 0.0
        self.button = None
    ...
    def set_current_map(self, new_map: Optional[SaiyanQuestMap]) -> None:
