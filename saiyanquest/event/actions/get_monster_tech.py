...
from saiyanquest.db import Comparison, Range
...
from saiyanquest.states.techniques import TechniqueMenuState
from saiyanquest.tools import compare, parse_flag
