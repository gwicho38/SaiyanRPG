...
from saiyanquest.audio import MusicPlayerState, SoundManager
from saiyanquest.boundary import BoundaryChecker
from saiyanquest.camera import CameraManager
from saiyanquest.cli.processor import CommandProcessor
from saiyanquest.collision_manager import CollisionManager
from saiyanquest.combat.session import CombatSession
from saiyanquest.config import SaiyanQuestConfig
from saiyanquest.constants import paths
from saiyanquest.event import get_event_bus
...
from saiyanquest.event.eventmanager import EventManager
from saiyanquest.event.eventpersist import EventPersist
from saiyanquest.map_loader import MapLoader
from saiyanquest.map_manager import MapManager
from saiyanquest.map_transition import MapTransition
from saiyanquest.movement import MovementManager, Pathfinder
from saiyanquest.networking import NetworkManager
from saiyanquest.npc_manager import NPCManager
from saiyanquest.park_tracker import ParkSession
from saiyanquest.platform_interface.events import PlayerInput
from saiyanquest.platform_interface.input_manager import InputManager
from saiyanquest.rumble import RumbleManager
from saiyanquest.session import local_session
from saiyanquest.state.draw import EventDebugDrawer, Renderer, StateDrawer
from saiyanquest.state.loader import StateLoader
from saiyanquest.state.manager import StateManager
from saiyanquest.state.repository import StateRepository
from saiyanquest.state.state import State
from saiyanquest.ui.cipher_processor import CipherProcessor
...
class LocalPygameClient:
    ...
    @classmethod
    def create(
        cls, config: SaiyanQuestConfig, screen: Surface
    ) -> LocalPygameClient:
        """
    ...
    def __init__(self, config: SaiyanQuestConfig, screen: Surface) -> None:
        self.config = config

        self.event_bus = get_event_bus()
        self.state_repository = StateRepository()
        loader = StateLoader(
            base_package="saiyanquest.states", lib_dir=paths.LIBDIR
        )
        loader.auto_state_discovery(self.state_repository)
        self.state_manager = StateManager(
            package="saiyanquest.states",
