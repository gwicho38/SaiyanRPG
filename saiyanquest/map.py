...
from saiyanquest.event import EventObject
from saiyanquest.graphics import scaled_image_loader
from saiyanquest.locale import T
from saiyanquest.math import Vector2, Vector3
from saiyanquest.tools import round_to_divisible
...
def get_pos_from_tilepos(
    current_map: SaiyanQuestMap, tile_position: Vector2
) -> tuple[int, int]:
    """
    ...
    Parameters:
        current_map: The map object (`SaiyanQuestMap`) containing the renderer
