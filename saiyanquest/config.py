...
from saiyanquest.constants.dialog_speed import DIALOG_SPEED_PROFILES
from saiyanquest.platform_interface.const import buttons, events

Animation.default_transition = "out_quint"


class SaiyanQuestConfig:
    """
    ...
    def update_attribute(
        ...
        """
        Updates the attribute's value in the saiyanquest.yaml.
