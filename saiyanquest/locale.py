...
from saiyanquest.constants.asset_loader import (
    fetch_all_l18n_roots,
    fetch_mod_asset_roots,
)
from saiyanquest.locale_dir.compiler import GettextCompiler
from saiyanquest.locale_dir.finder import LocaleFinder, LocaleInfo
from saiyanquest.locale_dir.translator import TranslatorPo
...
class TranslatorManager:
    ...
    def _get_translator_for_domain(
    ...
    def translate(self, message: str, domain: Optional[str] = None) -> str:
        """
