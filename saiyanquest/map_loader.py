...
from saiyanquest.compat import Rect
from saiyanquest.constants.asset_loader import fetch_asset
from saiyanquest.db import Direction, Orientation
from saiyanquest.event import EventObject, MapAction, MapCondition
from saiyanquest.graphics import scaled_image_loader
from saiyanquest.lib.bresenham import bresenham
from saiyanquest.map import (
    RegionProperties,
    SaiyanQuestMap,
    angle_of_points,
...
from saiyanquest.script.parser import (
    parse_action_string,
    parse_behav_string,
    parse_condition_string,
)
from saiyanquest.tools import copy_dict_with_keys
...
class MapLoader:
    ...
    def load_map_data(self, path: str) -> SaiyanQuestMap:
        """
        ...
        Returns:
            A SaiyanQuestMap object containing the loaded map data and events.
        """
    ...
    def _load_map_from_disk(self, path: str) -> SaiyanQuestMap:
        """
        ...
        Returns:
            A SaiyanQuestMap object with the loaded map data.
        """
        try:
    ...
    def _merge_events(
        ...
        """
        Merges processed events into the SaiyanQuestMap.

        Parameters:
            txmn_map: The SaiyanQuestMap object to update.
    ...
    def _process_and_merge_events(
        self, txmn_map: SaiyanQuestMap, path: str
    ) -> None:
        """
...
class TMXMapLoader:
    ...
    **Tiled:** http://www.mapeditor.org/
    ...
    def load(self, filename: str) -> SaiyanQuestMap:
