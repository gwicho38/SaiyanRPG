...
from saiyanquest import log, prepare
from saiyanquest.client import LocalPygameClient
from saiyanquest.db import db
from saiyanquest.headless_client import HeadlessClient
from saiyanquest.launcher import GameLauncher
...
def main(config: SaiyanQuestConfig, load_slot: Optional[int] = None) -> None:
    """
...
def headless(config: SaiyanQuestConfig) -> None:
    """
